...
const NOTIFICATION_MAP: Record<string, { type: NotificationType; title: string }> = {
  ...
  skill_requested: { type: "system_alert", title: "Skill Requested" },
  skill_approved: { type: "system_alert", title: "Skill Approved" },
  skill_rejected: { type: "system_alert", title: "Skill Rejected" },
  skill_installed: { type: "system_alert", title: "Skill Installed" },
  skill_scan_clean: { type: "system_alert", title: "Skill Scan Clean" },
  skill_scan_flagged: { type: "system_alert", title: "Skill Scan Flagged" },
  discussion_started: { type: "system_alert", title: "Discussion Started" },
  discussion_summary_logged: { type: "system_alert", title: "Discussion Summary" },
  finding_logged: { type: "system_alert", title: "Finding Logged" },
  proposal_created: { type: "system_alert", title: "Proposal Created" },
  approval_requested: { type: "system_alert", title: "Approval Requested" },
  approval_granted: { type: "system_alert", title: "Approval Granted" },
  approval_rejected: { type: "system_alert", title: "Approval Rejected" },
  task_returned_for_rework: { type: "system_alert", title: "Task Returned for Rework" },
